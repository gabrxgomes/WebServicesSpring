...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Category cat1 = new Category(null, "Electronics"); //pode ficar aqui em cima porque categoria é uma
		...
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5)); //salvando os objs com suas relações many to many
		...
		userRepository.saveAll(Arrays.asList(u1, u2)); //TEM Q FICAR NA ORDEM CORRETA OK #1
		orderRepository.saveAll(Arrays.asList(o1, o2, o3)); //#2
		...
		//pra salvar no banco de dados precisamos do repository
